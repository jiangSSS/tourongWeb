          ...
          <div class="clearfix">
            <div class="fll clearfix">
              ...
              <div class="box_content fll" v-if="project&&project.financeBodyName">
                ...
                <span class="list-content">{{project.financeBodyName}}</span>
              </div>
              ...
              <div class="box_content fll" v-if="project&&project.industryName">
                ...
                <span class="list-content">{{project.industryName}}</span>
              </div>
            ...
            <div class="fll"> -->
              <div class="box_content fll" v-if="project&&project.financingWayName">
                ...
                <span class="list-content">{{project.financingWayName}}</span>
              </div>
              ...
              <div class="box_content fll" v-if="project&&project.paymentTypeName">
                ...
                <span class="list-content">{{project.paymentTypeName}}</span>
              </div>
              <div class="box_content fll" v-if="project&&project.industryName">
              ...
              <div class="box_content fll" v-if="project&&project.financingMoneyName">
                ...
                <span class="list-content">{{project.financingMoneyName}}</span>
              </div>
              <div class="box_content fll" v-if="project&&project.intentCapitalList">
                <span class="list-contentName">意向资金:</span>
                <span class="list-content">{{project.intentCapitalList}}</span>
              </div>
            </div>
            <div class="flr">
        ...
        <div class="requireContent clearfix">
          <div class="fll">
            ...
            <div class="box_content" v-if="project&&project.registeredCapitalStr">
              ...
              <span class="list-content">{{project.registeredCapitalStr}}万</span>
            </div>
          ...
          <div class="fll">
            ...
            <div class="box_content" v-if="project&&project.companyFoundTimeStr">
              ...
              <span class="list-content">{{project.companyFoundTimeStr}}</span>
            </div>
        ...
        <el-form>
          <el-form-item label="资金" label-width="100">
            <el-select v-model="capitalId" placeholder="请选择资金">
              <el-option v-for="item in myMoney" :key="item.id" :label="item.title" :value="item.id"></el-option>
              <el-pagination v-show="myMoney_pagination" small @current-change="handleCurrentChange" layout="total, prev, pager, next"
                :total="myMoney_Count"></el-pagination>
            </el-select>
          </el-form-item>
        </el-form>
