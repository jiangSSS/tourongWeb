      ...
      <el-form ref="formData" :model="formData" label-width="150px" :rules="rules">
        ...
        <el-form-item label="资金主体">
          <el-radio-group v-model="formData.capitalBody">
            <el-radio v-for="capital in capitalBodyList" :key="capital.dataValue" :label="capital.dataValue">{{capital.dataName}}</el-radio>
          </el-radio-group>
        </el-form-item>
        ...
        <el-form-item label="投资地区" class="is-required">
          <v-distpicker :province="provinceStr1" :city="cityStr1" :area="countyStr1" @selected="selected1"></v-distpicker>
        </el-form-item>
        <el-form-item label="投资金额" class="is-required" prop="investAmount">
          <el-select v-model="formData.investAmount" placeholder="请选择">
            <el-option v-for="item in investAmountList" :key="item.dataValue" :label="item.dataName" :value="item.dataValue">{{item.dataName}}</el-option>
          </el-select>
        </el-form-item>
        <el-form-item label="投资行业" class="is-required" prop="investIndustrys">
          <el-checkbox-group v-model="investIndustrys">
            <el-checkbox v-for="industry in investIndustryList" :label="industry.dataValue" :key="industry.dataValue" name="type">{{industry.dataName}}</el-checkbox>
          </el-checkbox-group>
        </el-form-item>
        <el-form-item label="投资阶段" class="is-required" prop="investStages">
          <el-checkbox-group v-model="investStages">
            <el-checkbox v-for="investStage in investStageList" :label="investStage.dataValue" :key="investStage.dataValue" name="type">{{investStage.dataName}}</el-checkbox>
          </el-checkbox-group>
        </el-form-item>
        <el-form-item label="资金来源">
          <el-checkbox-group v-model="capitalSources">
            <el-checkbox v-for="capitalSource in capitalSourceList" :label="capitalSource.dataValue" :key="capitalSource.dataValue" name="type">{{capitalSource.dataName}}</el-checkbox>
          </el-checkbox-group>
        </el-form-item>
        <el-form-item label="投资类型" class="is-required" prop="investTypes">
          <el-checkbox-group v-model="investTypes">
            <el-checkbox v-for="investType in investTypeList" :label="investType.dataValue" :key="investType.dataValue" name="type">{{investType.dataName}}</el-checkbox>
          </el-checkbox-group>
        </el-form-item>
        <el-form-item label="前期费用">
          <el-radio-group v-model="formData.upfrontCost">
            <el-radio v-for="upfrontCost in upfrontCostList" :key="upfrontCost.dataValue" :label="upfrontCost.dataValue">{{upfrontCost.dataName}}</el-radio>
          </el-radio-group>
        </el-form-item>
        ...
        <el-form-item label="有效期限" class="is-required" prop="validStartTimeStr">
          <div style="width:28.16667%" class="fll">
            <el-date-picker type="date" placeholder="选择日期" v-model="formData.validStartTimeStr" value-format="yyyy-MM-dd"></el-date-picker>
          </div>
        ...
        <el-form-item label="风控要求">
          <el-checkbox-group v-model="riskControls">
            <el-checkbox v-for="riskControl in riskControlList" :label="riskControl.dataValue" :key="riskControl.dataValue" name="type">{{riskControl.dataName}}</el-checkbox>
          </el-checkbox-group>
        </el-form-item>
        <el-form-item label="材料要求">
          <el-checkbox-group v-model="datums">
            <el-checkbox v-for="datum in datumList" :label="datum.dataValue" :key="datum.dataValue" name="type">{{datum.dataName}}</el-checkbox>
          </el-checkbox-group>
        </el-form-item>
        <el-form-item label="抵押物类型">
          <el-checkbox-group v-model="pawnTypes">
            <el-checkbox v-for="pawnType in pawnTypeList" :label="pawnType.dataValue" :key="pawnType.dataValue" name="type">{{pawnType.dataName}}</el-checkbox>
          </el-checkbox-group>
        </el-form-item>
