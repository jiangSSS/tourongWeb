  ...
  <div class="fll">
    <div class="person_content">
      ...
      <el-form :model="ruleForm" :rules="rules" ref="ruleForm">
        ...
        <el-form-item label="上传文件" style="margin-left:5px;" prop="fileList">
      ...
      <div class="invest-menu clearfix" style="border-top: 1px solid #ededed;">
        <div v-for="(item , index) in pageList" :key="index" class="invest-item fll clearfix">
          ...
          <span class="flr not" v-else>待审核</span>
    ...
    return {
      ...
      rules: {
        applyTitle: {
         ...
         fileList:[{ required: true, message: '请上传项目相关文件', trigger: 'blur'}],
      },
      hint:"",
      success:false,
      toast_show:false,
